 ...
 *
 * Para agregar/quitar campos de la Ficha técnica o de los Avances
 * particulares, edita las listas FICHA_TECNICA y PARTICULARES de abajo:
 * cada entrada es [columna del Excel, etiqueta a mostrar].
 */
(function () {
  ...
  // Ficha técnica agrupada: { grupo, campos: [[columna, etiqueta], ...] }
  const FICHA_TECNICA = [
    {
      grupo: "Generales",
      campos: [
    ...
    },
    {
      ...
      campos: [
        ...
        ["ft_mod_cantidad", "Cantidad de módulos"],
      ],
    },
    {
      grupo: "Inversores",
      campos: [
        ["ft_inv_capacidad", "Capacidad MWac"],
        ["ft_inv_tipo", "Tipo"],
      ],
    },
    {
    ...
    },
    {
      ...
      campos: [["ft_sae", "SAE (Formación de red) 30% MWac / 3 hr respaldo MWh"]],
    },
  ];
  ...
  function mostrarProyecto(p) {
    ...
    // Ficha técnica
    $("fichaBody").innerHTML = FICHA_TECNICA.map(({ grupo, campos }) => `
